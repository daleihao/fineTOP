...
for variable_name_i = 1:3
    ...
    for season_i = 1:5
        ...
        if (~strcmp(variable_name_MODIS, 'FSNO'))
           ...
           oldTOP_seasons = oldTOP_seasons;
        end
        save(['data/' variable_name_MODIS '_seasonal_ELM_MODIS_' num2str(season_i) '_modify_with_top.mat'],'kTOP_surf_seasons','kTOP_nosurf_seasons','oldTOP_seasons','default_seasons','MODIS_data');
    end
