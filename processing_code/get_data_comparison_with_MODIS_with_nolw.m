...
kTOP_nolw_nosurf_filename = '../long_term_run/ktop_SN_rad_nolw_nosurf_MODIS_run_multi_year_average.nc';
...
for variable_name_i = 1:3
    ...
    kTOP_nolw_nosurf_variables = ncread(kTOP_nolw_nosurf_filename, variable_name);
    ...
    for season_i = 1:5
        ...
        kTOP_nolw_nosurf_seasons = mean(kTOP_nolw_nosurf_variables(:,:,season_filter),3,'omitnan');
        ...
        kTOP_nolw_nosurf_seasons = flipud(kTOP_nolw_nosurf_seasons');
        ...
        if (~strcmp(variable_name_MODIS, 'FSNO'))
           ...
           kTOP_nolw_nosurf_seasons = kTOP_nolw_nosurf_seasons;
        end
        save(['data/' variable_name_MODIS '_seasonal_ELM_MODIS_' num2str(season_i) '_modify_with_nolw.mat'],'kTOP_surf_seasons','kTOP_nosurf_seasons','kTOP_nolw_nosurf_seasons','default_seasons','MODIS_data');
    end
